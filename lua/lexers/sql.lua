...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match({
    ...
    'fetch', 'float', 'for', 'force', 'foreign', 'from', 'fulltext', 'goto',
    'grant', 'group', 'having', 'high_priority', 'hour_microsecond',
    'hour_minute', 'hour_second', 'if', 'ignore', 'in', 'index', 'infile',
    'inner', 'inout', 'insensitive', 'insert', 'int', 'integer', 'interval',
    ...
    'read', 'reads', 'real', 'references', 'regexp', 'rename', 'repeat',
    ...
    'straight_join', 'table', 'terminated', 'text', 'then', 'tinyblob',
