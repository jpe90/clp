...
-- Instructions.
lex:add_rule('instruction', lex:tag(lexer.FUNCTION_BUILTIN .. '.instruction',
                                    lex:word_match('instruction')))

-- Registers.
lex:add_rule('register', lex:tag(lexer.CONSTANT_BUILTIN .. '.register',
                                 lex:word_match('register')))
...
lex:add_rule('constant', lex:tag(lexer.CONSTANT_BUILTIN, lex:word_match(
                                     lexer.CONSTANT_BUILTIN) + '$' * P('$') ^ -1 *
                                     -word))
...
lex:set_word_list(lexer.KEYWORD, {
    ...
    '.nolist', -- Preprocessor Packages.
    'altreg', 'smartalign', 'fp', 'ifunc', -- Directives.
    'absolute', 'bits', 'class', 'common', 'common', 'cpu', 'default', 'export',
    'extern', 'float', 'global', 'group', 'import', 'osabi', 'overlay',
    'private', 'public', '__SECT__', 'section', 'segment', 'stack', 'use16',
    'use32', 'use64', -- Section Names.
    '.bss', '.comment', '.data', '.lbss', '.ldata', '.lrodata', '.rdata',
    '.rodata', '.tbss', '.tdata', '.text', -- Section Qualifiers.
    'alloc', 'bss', 'code', 'exec', 'data', 'noalloc', 'nobits', 'noexec',
    'nowrite', 'progbits', 'rdata', 'tls', 'write', -- Operators.
    'abs', 'rel', 'seg', 'wrt', 'strict', '__utf16__', '__utf16be__',
    '__utf16le__', '__utf32__', '__utf32be__', '__utf32le__'
})
...
lex:set_word_list('instruction', {
    ...
    'rest', 'resw', 'resy', -- Conventional Instructions.
    ...
    'ftst', 'fucom', 'fucomi', 'fucomip', 'fucomp', 'fucompp', 'fxam', 'fxch',
    'fxtract', 'fyl2x', 'fyl2xp1', 'hlt', 'ibts', 'icebp', 'idiv', 'imul', 'in',
    'inc', 'incbin', 'insb', 'insd', 'insw', 'int', 'int01', 'int1', 'int03',
    'int3', 'into', 'invd', 'invpcid', 'invlpg', 'invlpga', 'iret', 'iretd',
    'iretq', 'iretw', 'jcxz', 'jecxz', 'jrcxz', 'jmp', 'jmpe', 'lahf', 'lar',
    'lds', 'lea', 'leave', 'les', 'lfence', 'lfs', 'lgdt', 'lgs', 'lidt',
    'lldt', 'lmsw', 'loadall', 'loadall286', 'lodsb', 'lodsd', 'lodsq', 'lodsw',
    'loop', 'loope', 'loopne', 'loopnz', 'loopz', 'lsl', 'lss', 'ltr', 'mfence',
    'monitor', 'mov', 'movd', 'movq', 'movsb', 'movsd', 'movsq', 'movsw',
    'movsx', 'movsxd', 'movsx', 'movzx', 'mul', 'mwait', 'neg', 'nop', 'not',
    'or', 'out', 'outsb', 'outsd', 'outsw', 'packssdw', 'packsswb', 'packuswb',
    'paddb', 'paddd', 'paddsb', 'paddsiw', 'paddsw', 'paddusb', 'paddusw',
    'paddw', 'pand', 'pandn', 'pause', 'paveb', 'pavgusb', 'pcmpeqb', 'pcmpeqd',
    'pcmpeqw', 'pcmpgtb', 'pcmpgtd', 'pcmpgtw', 'pdistib', 'pf2id', 'pfacc',
    'pfadd', 'pfcmpeq', 'pfcmpge', 'pfcmpgt', 'pfmax', 'pfmin', 'pfmul',
    'pfrcp', 'pfrcpit1', 'pfrcpit2', 'pfrsqit1', 'pfrsqrt', 'pfsub', 'pfsubr',
    'pi2fd', 'pmachriw', 'pmaddwd', 'pmagw', 'pmulhriw', 'pmulhrwa', 'pmulhrwc',
    'pmulhw', 'pmullw', 'pmvgezb', 'pmvlzb', 'pmvnzb', 'pmvzb', 'pop', 'popa',
    'popad', 'popaw', 'popf', 'popfd', 'popfq', 'popfw', 'por', 'prefetch',
    'prefetchw', 'pslld', 'psllq', 'psllw', 'psrad', 'psraw', 'psrld', 'psrlq',
    'psrlw', 'psubb', 'psubd', 'psubsb', 'psubsiw', 'psubsw', 'psubusb',
    'psubusw', 'psubw', 'punpckhbw', 'punpckhdq', 'punpckhwd', 'punpcklbw',
    'punpckldq', 'punpcklwd', 'push', 'pusha', 'pushad', 'pushaw', 'pushf',
    'pushfd', 'pushfq', 'pushfw', 'pxor', 'rcl', 'rcr', 'rdshr', 'rdmsr',
    'rdpmc', 'rdtsc', 'rdtscp', 'ret', 'retf', 'retn', 'rol', 'ror', 'rdm',
    'rsdc', 'rsldt', 'rsm', 'rsts', 'sahf', 'sal', 'salc', 'sar', 'sbb',
    'scasb', 'scasd', 'scasq', 'scasw', 'sfence', 'sgdt', 'shl', 'shld', 'shr',
    'shrd', 'sidt', 'sldt', 'skinit', 'smi', 'smint', 'smintold', 'smsw', 'stc',
    'std', 'sti', 'stosb', 'stosd', 'stosq', 'stosw', 'str', 'sub', 'svdc',
    'svldt', 'svts', 'swapgs', 'syscall', 'sysenter', 'sysexit', 'sysret',
    'test', 'ud0', 'ud1', 'ud2b', 'ud2', 'ud2a', 'umov', 'verr', 'verw',
    'fwait', 'wbinvd', 'wrshr', 'wrmsr', 'xadd', 'xbts', 'xchg', 'xlatb',
    'xlat', 'xor', 'xor', 'cmova', 'cmovae', 'cmovb', 'cmovbe', 'cmovc',
    ...
    'cmpunordss', 'cmpps', 'cmpss', 'comiss', 'cvtpi2ps', 'cvtps2pi',
    'cvtsi2ss', 'cvtss2si', 'cvttps2pi', 'cvttss2si', 'divps', 'divss',
    'ldmxcsr', 'maxps', 'maxss', 'minps', 'minss', 'movaps', 'movhps',
    'movlhps', 'movlps', 'movhlps', 'movmskps', 'movntps', 'movss', 'movups',
    'mulps', 'mulss', 'orps', 'rcpps', 'rcpss', 'rsqrtps', 'rsqrtss', 'shufps',
    'sqrtps', 'sqrtss', 'stmxcsr', 'subps', 'subss', 'ucomiss', 'unpckhps',
    'unpcklps', 'xorps',
    -- Introduced in Deschutes but necessary for SSE support.
    'fxrstor', 'fxrstor64', 'fxsave', 'fxsave64',
    -- XSAVE group (AVX and extended state).
    'xgetbv', 'xsetbv', 'xsave', 'xsave64', 'xsaveopt', 'xsaveopt64', 'xrstor',
    'xrstor64', -- Generic memory operations.
    ...
    'paddsw', 'paddusb', 'paddusw', 'pand', 'pandn', 'pavgb', 'pavgw',
    'pcmpeqb', 'pcmpeqw', 'pcmpeqd', 'pcmpgtb', 'pcmpgtw', 'pcmpgtd', 'pextrw',
    'pinsrw', 'pmaddwd', 'pmaxsw', 'pmaxub', 'pminsw', 'pminub', 'pmovmskb',
    'pmulhuw', 'pmulhw', 'pmullw', 'pmuludq', 'por', 'psadbw', 'pshufd',
    'pshufhw', 'pshuflw', 'pslldq', 'psllw', 'pslld', 'psllq', 'psraw', 'psrad',
    'psrldq', 'psrlw', 'psrld', 'psrlq', 'psubb', 'psubw', 'psubd', 'psubq',
    'psubsb', 'psubsw', 'psubusb', 'psubusw', 'punpckhbw', 'punpckhwd',
    'punpckhdq', 'punpckhqdq', 'punpcklbw', 'punpcklwd', 'punpckldq',
    'punpcklqdq', 'pxor', -- Willamette Streaming SIMD instructions (SSE2).
    ...
    'movddup', 'movshdup', 'movsldup', -- VMX/SVM Instructions.
    'clgi', 'stgi', 'vmcall', 'vmclear', 'vmfunc', 'vmlaunch', 'vmload',
    'vmmcall', 'vmptrld', 'vmptrst', 'vmread', 'vmresume', 'vmrun', 'vmsave',
    'vmwrite', 'vmxoff', 'vmxon', -- Extended Page Tables VMX instructions.
    'invept', 'invvpid', -- Tejas New Instructions (SSSE3).
    'pabsb', 'pabsw', 'pabsd', 'palignr', 'phaddw', 'phaddd', 'phaddsw',
    'phsubw', 'phsubd', 'phsubsw', 'pmaddubsw', 'pmulhrsw', 'pshufb', 'psignb',
    'psignw', 'psignd', -- AMD SSE4A.
    'extrq', 'insertq', 'movntsd', 'movntss', -- New instructions in Barcelona.
    'lzcnt', -- Penryn New Instructions (SSE4.1).
    ...
    'pminsd', 'pminud', 'pminuw', 'pmovsxbw', 'pmovsxbd', 'pmovsxbq',
    'pmovsxwd', 'pmovsxwq', 'pmovsxdq', 'pmovzxbw', 'pmovzxbd', 'pmovzxbq',
    'pmovzxwd', 'pmovzxwq', 'pmovzxdq', 'pmuldq', 'pmulld', 'ptest', 'roundpd',
    'roundps', 'roundsd', 'roundss', -- Nehalem New Instructions (SSE4.2).
    'crc32', 'pcmpestri', 'pcmpestrm', 'pcmpistri', 'pcmpistrm', 'pcmpgtq',
    'popcnt', -- Intel SMX.
    'getsec', -- Geode (Cyrix) 3DNow! additions.
    'pfrcpv', 'pfrsqrtv', -- Intel new instructions in ???.
    'movbe', -- Intel AES instructions.
    'aesenc', 'aesenclast', 'aesdec', 'aesdeclast', 'aesimc', 'aeskeygenassist',
    -- Intel AVX AES instructions.
    'vaesenc', 'vaesenclast', 'vaesdec', 'vaesdeclast', 'vaesimc',
    'vaeskeygenassist', -- Intel AVX instructions.
    'vaddpd', 'vaddps', 'vaddsd', 'vaddss', 'vaddsubpd', 'vaddsubps', 'vandpd',
    'vandps', 'vandnpd', 'vandnps', 'vblendpd', 'vblendps', 'vblendvpd',
    'vblendvps', 'vbroadcastss', 'vbroadcastsd', 'vbroadcastf128',
    ...
    'vcmpeq_osps', 'vcmpeqps', 'vcmplt_osps', 'vcmpltps', 'vcmple_osps',
    'vcmpleps', 'vcmpunord_qps', 'vcmpunordps', 'vcmpneq_uqps', 'vcmpneqps',
    'vcmpnlt_usps', 'vcmpnltps', 'vcmpnle_usps', 'vcmpnleps', 'vcmpord_qps',
    'vcmpordps', 'vcmpeq_uqps', 'vcmpnge_usps', 'vcmpngeps', 'vcmpngt_usps',
    'vcmpngtps', 'vcmpfalse_oqps', 'vcmpfalseps', 'vcmpneq_oqps', 'vcmpge_osps',
    'vcmpgeps', 'vcmpgt_osps', 'vcmpgtps', 'vcmptrue_uqps', 'vcmptrueps',
    ...
    'vcmpeq_ossd', 'vcmpeqsd', 'vcmplt_ossd', 'vcmpltsd', 'vcmple_ossd',
    'vcmplesd', 'vcmpunord_qsd', 'vcmpunordsd', 'vcmpneq_uqsd', 'vcmpneqsd',
    'vcmpnlt_ussd', 'vcmpnltsd', 'vcmpnle_ussd', 'vcmpnlesd', 'vcmpord_qsd',
    'vcmpordsd', 'vcmpeq_uqsd', 'vcmpnge_ussd', 'vcmpngesd', 'vcmpngt_ussd',
    'vcmpngtsd', 'vcmpfalse_oqsd', 'vcmpfalsesd', 'vcmpneq_oqsd', 'vcmpge_ossd',
    'vcmpgesd', 'vcmpgt_ossd', 'vcmpgtsd', 'vcmptrue_uqsd', 'vcmptruesd',
    ...
    'vcmpeq_osss', 'vcmpeqss', 'vcmplt_osss', 'vcmpltss', 'vcmple_osss',
    'vcmpless', 'vcmpunord_qss', 'vcmpunordss', 'vcmpneq_uqss', 'vcmpneqss',
    'vcmpnlt_usss', 'vcmpnltss', 'vcmpnle_usss', 'vcmpnless', 'vcmpord_qss',
    'vcmpordss', 'vcmpeq_uqss', 'vcmpnge_usss', 'vcmpngess', 'vcmpngt_usss',
    'vcmpngtss', 'vcmpfalse_oqss', 'vcmpfalsess', 'vcmpneq_oqss', 'vcmpge_osss',
    'vcmpgess', 'vcmpgt_osss', 'vcmpgtss', 'vcmptrue_uqss', 'vcmptruess',
    ...
    'vcvttsd2si', 'vcvttss2si', 'vdivpd', 'vdivps', 'vdivsd', 'vdivss', 'vdppd',
    'vdpps', 'vextractf128', 'vextractps', 'vhaddpd', 'vhaddps', 'vhsubpd',
    'vhsubps', 'vinsertf128', 'vinsertps', 'vlddqu', 'vldqqu', 'vlddqu',
    'vldmxcsr', 'vmaskmovdqu', 'vmaskmovps', 'vmaskmovpd', 'vmaxpd', 'vmaxps',
    'vmaxsd', 'vmaxss', 'vminpd', 'vminps', 'vminsd', 'vminss', 'vmovapd',
    'vmovaps', 'vmovd', 'vmovq', 'vmovddup', 'vmovdqa', 'vmovqqa', 'vmovdqa',
    'vmovdqu', 'vmovqqu', 'vmovdqu', 'vmovhlps', 'vmovhpd', 'vmovhps',
    'vmovlhps', 'vmovlpd', 'vmovlps', 'vmovmskpd', 'vmovmskps', 'vmovntdq',
    'vmovntqq', 'vmovntdq', 'vmovntdqa', 'vmovntpd', 'vmovntps', 'vmovsd',
    'vmovshdup', 'vmovsldup', 'vmovss', 'vmovupd', 'vmovups', 'vmpsadbw',
    'vmulpd', 'vmulps', 'vmulsd', 'vmulss', 'vorpd', 'vorps', 'vpabsb',
    'vpabsw', 'vpabsd', 'vpacksswb', 'vpackssdw', 'vpackuswb', 'vpackusdw',
    'vpaddb', 'vpaddw', 'vpaddd', 'vpaddq', 'vpaddsb', 'vpaddsw', 'vpaddusb',
    'vpaddusw', 'vpalignr', 'vpand', 'vpandn', 'vpavgb', 'vpavgw', 'vpblendvb',
    'vpblendw', 'vpcmpestri', 'vpcmpestrm', 'vpcmpistri', 'vpcmpistrm',
    'vpcmpeqb', 'vpcmpeqw', 'vpcmpeqd', 'vpcmpeqq', 'vpcmpgtb', 'vpcmpgtw',
    'vpcmpgtd', 'vpcmpgtq', 'vpermilpd', 'vpermilps', 'vperm2f128', 'vpextrb',
    'vpextrw', 'vpextrd', 'vpextrq', 'vphaddw', 'vphaddd', 'vphaddsw',
    'vphminposuw', 'vphsubw', 'vphsubd', 'vphsubsw', 'vpinsrb', 'vpinsrw',
    'vpinsrd', 'vpinsrq', 'vpmaddwd', 'vpmaddubsw', 'vpmaxsb', 'vpmaxsw',
    'vpmaxsd', 'vpmaxub', 'vpmaxuw', 'vpmaxud', 'vpminsb', 'vpminsw', 'vpminsd',
    'vpminub', 'vpminuw', 'vpminud', 'vpmovmskb', 'vpmovsxbw', 'vpmovsxbd',
    'vpmovsxbq', 'vpmovsxwd', 'vpmovsxwq', 'vpmovsxdq', 'vpmovzxbw',
    'vpmovzxbd', 'vpmovzxbq', 'vpmovzxwd', 'vpmovzxwq', 'vpmovzxdq', 'vpmulhuw',
    'vpmulhrsw', 'vpmulhw', 'vpmullw', 'vpmulld', 'vpmuludq', 'vpmuldq', 'vpor',
    'vpsadbw', 'vpshufb', 'vpshufd', 'vpshufhw', 'vpshuflw', 'vpsignb',
    'vpsignw', 'vpsignd', 'vpslldq', 'vpsrldq', 'vpsllw', 'vpslld', 'vpsllq',
    'vpsraw', 'vpsrad', 'vpsrlw', 'vpsrld', 'vpsrlq', 'vptest', 'vpsubb',
    'vpsubw', 'vpsubd', 'vpsubq', 'vpsubsb', 'vpsubsw', 'vpsubusb', 'vpsubusw',
    'vpunpckhbw', 'vpunpckhwd', 'vpunpckhdq', 'vpunpckhqdq', 'vpunpcklbw',
    'vpunpcklwd', 'vpunpckldq', 'vpunpcklqdq', 'vpxor', 'vrcpps', 'vrcpss',
    'vrsqrtps', 'vrsqrtss', 'vroundpd', 'vroundps', 'vroundsd', 'vroundss',
    'vshufpd', 'vshufps', 'vsqrtpd', 'vsqrtps', 'vsqrtsd', 'vsqrtss',
    'vstmxcsr', 'vsubpd', 'vsubps', 'vsubsd', 'vsubss', 'vtestps', 'vtestpd',
    ...
    'vpclmulqdq', -- Intel Fused Multiply-Add instructions (FMA).
    ...
    'vpmadcsswd', 'vpmadcswd', 'vpperm', 'vprotb', 'vprotd', 'vprotq', 'vprotw',
    'vpshab', 'vpshad', 'vpshaq', 'vpshaw', 'vpshlb', 'vpshld', 'vpshlq',
    'vpshlw', -- Intel AVX2 instructions.
    'vmpsadbw', 'vpabsb', 'vpabsw', 'vpabsd', 'vpacksswb', 'vpackssdw',
    'vpackusdw', 'vpackuswb', 'vpaddb', 'vpaddw', 'vpaddd', 'vpaddq', 'vpaddsb',
    'vpaddsw', 'vpaddusb', 'vpaddusw', 'vpalignr', 'vpand', 'vpandn', 'vpavgb',
    'vpavgw', 'vpblendvb', 'vpblendw', 'vpcmpeqb', 'vpcmpeqw', 'vpcmpeqd',
    'vpcmpeqq', 'vpcmpgtb', 'vpcmpgtw', 'vpcmpgtd', 'vpcmpgtq', 'vphaddw',
    'vphaddd', 'vphaddsw', 'vphsubw', 'vphsubd', 'vphsubsw', 'vpmaddubsw',
    'vpmaddwd', 'vpmaxsb', 'vpmaxsw', 'vpmaxsd', 'vpmaxub', 'vpmaxuw',
    'vpmaxud', 'vpminsb', 'vpminsw', 'vpminsd', 'vpminub', 'vpminuw', 'vpminud',
    'vpmovmskb', 'vpmovsxbw', 'vpmovsxbd', 'vpmovsxbq', 'vpmovsxwd',
    'vpmovsxwq', 'vpmovsxdq', 'vpmovzxbw', 'vpmovzxbd', 'vpmovzxbq',
    ...
    'vbroadcasti128', 'vpblendd', 'vpbroadcastb', 'vpbroadcastw',
    'vpbroadcastd', 'vpbroadcastq', 'vpermd', 'vpermpd', 'vpermps', 'vpermq',
    'vperm2i128', 'vextracti128', 'vinserti128', 'vpmaskmovd', 'vpmaskmovq',
    'vpmaskmovd', 'vpmaskmovq', 'vpsllvd', 'vpsllvq', 'vpsllvd', 'vpsllvq',
    'vpsravd', 'vpsrlvd', 'vpsrlvq', 'vpsrlvd', 'vpsrlvq', 'vgatherdpd',
    'vgatherqpd', 'vgatherdpd', 'vgatherqpd', 'vgatherdps', 'vgatherqps',
    'vgatherdps', 'vgatherqps', 'vpgatherdd', 'vpgatherqd', 'vpgatherdd',
    'vpgatherqd', 'vpgatherdq', 'vpgatherqq', 'vpgatherdq', 'vpgatherqq',
...
lex:set_word_list('register', {
    -- 32-bit registers.
    'ah', 'al', 'ax', 'bh', 'bl', 'bp', 'bx', 'ch', 'cl', 'cx', 'dh', 'di',
    'dl', 'dx', 'eax', 'ebx', 'ebx', 'ecx', 'edi', 'edx', 'esi', 'esp', 'fs',
    'mm0', 'mm1', 'mm2', 'mm3', 'mm4', 'mm5', 'mm6', 'mm7', 'si', 'st0', 'st1',
    'st2', 'st3', 'st4', 'st5', 'st6', 'st7', 'xmm0', 'xmm1', 'xmm2', 'xmm3',
    'xmm4', 'xmm5', 'xmm6', 'xmm7', 'ymm0', 'ymm1', 'ymm2', 'ymm3', 'ymm4',
    'ymm5', 'ymm6', 'ymm7', -- 64-bit registers.
    ...
    'rdi', 'rdx', 'rsi', 'rsp', 'sil', 'xmm8', 'xmm9', 'xmm10', 'xmm11',
    'xmm12', 'xmm13', 'xmm14', 'xmm15', 'ymm8', 'ymm9', 'ymm10', 'ymm11',
...
lex:set_word_list(lexer.TYPE .. '.wrt',
                  'start gotpc gotoff gottpoff got plt sym tlsie')

lex:set_word_list(lexer.CONSTANT_BUILTIN, {
    '__float128h__', '__float128l__', '__float16__', '__float32__',
    '__float64__', '__float8__', '__float80e__', '__float80m__', '__Infinity__',
    '__NaN__', '__QNaN__', '__SNaN__'
})

lex:set_word_list(lexer.PREPROCESSOR, {
    'arg', 'assign', 'clear', 'define', 'defstr', 'deftok', 'depend', 'elif',
    'elifctx', 'elifdef', 'elifempty', 'elifenv', 'elifid', 'elifidn',
    ...
    'endif', 'endmacro', 'endrep', 'endwhile', 'error', 'exitmacro', 'exitrep',
    'exitwhile', 'fatal', 'final', 'idefine', 'idefstr', 'ideftok', 'if',
    'ifctx', 'ifdef', 'ifempty', 'ifenv', 'ifid', 'ifidn', 'ifidni', 'ifmacro',
    'ifn', 'ifnctx', 'ifndef', 'ifnempty', 'ifnenv', 'ifnid', 'ifnidn',
    'ifnidni', 'ifnmacro', 'ifnnum', 'ifnstr', 'ifntoken', 'ifnum', 'ifstr',
    'iftoken', 'imacro', 'include', 'ixdefine', 'line', 'local', 'macro',
    'pathsearch', 'pop', 'push', 'rep', 'repl', 'rmacro', 'rotate', 'stacksize',
    'strcat', 'strlen', 'substr', 'undef', 'unmacro', 'use', 'warning', 'while',
    'xdefine'
})
