...
-- Variables.
lex:add_rule('variable', lex:tag(lexer.VARIABLE_BUILTIN,
...
lex:set_word_list(lexer.KEYWORD, {
    ...
    'pause', 'plot', 'using', 'with', 'index', 'every', 'smooth', 'thru',
    'print', 'pwd', 'quit', 'replot', 'reread', 'reset', 'save', 'set', 'show',
    'unset', 'shell', 'splot', 'system', 'test', 'unset', 'update'
})
