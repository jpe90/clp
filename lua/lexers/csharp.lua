...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match {
    ...
    'foreach', 'get', 'goto', 'if', 'in', 'is', 'new', 'remove', 'return',
    'set', 'sizeof', 'stackalloc', 'super', 'switch', 'this', 'throw', 'try',
    'typeof', 'unchecked', 'value', 'var', 'void', 'while', 'yield', 'null',
    'true', 'false'
}))
...
lex:add_rule('type', token(lexer.TYPE, word_match {
    ...
    'object', 'operator', 'sbyte', 'short', 'string', 'uint', 'ulong', 'ushort'
}))
