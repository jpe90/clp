...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match {
    ...
    'exec', 'exit', 'fg', 'fish', 'fish_config', 'fishd', 'fish_indent',
    'fish_pager', 'fish_prompt', 'fish_right_prompt', 'fish_update_completions',
    'for', 'funced', 'funcsave', 'function', 'functions', 'help', 'history',
    'if', 'in', 'isatty', 'jobs', 'math', 'mimedb', 'nextd', 'not', 'open',
    'or', 'popd', 'prevd', 'psub', 'pushd', 'pwd', 'random', 'read', 'return',
    'set', 'set_color', 'source', 'status', 'switch', 'test', 'trap', 'type',
