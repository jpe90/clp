...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match {
    'and', 'break', 'cast', 'continue', 'elif', 'else', 'ensure', 'except',
    'for', 'given', 'goto', 'if', 'in', 'isa', 'is', 'not', 'or', 'otherwise',
    'pass', 'raise', 'ref', 'try', 'unless', 'when', 'while', -- Definitions.
    ...
    'struct', 'transient', 'virtual', 'yield', -- Namespaces.
    'as', 'from', 'import', 'namespace', -- Other.
...
lex:add_rule('function', token(lexer.FUNCTION, word_match {
    ...
    'len', 'lock', 'map', 'matrix', 'max', 'min', 'normalArrayIndexing',
    'print', 'property', 'range', 'rawArrayIndexing', 'required', '__switch__',
    'typeof', 'unchecked', 'using', 'yieldAll', 'zip'
}))
...
-- Numbers.
lex:add_rule('number',
             token(lexer.NUMBER, lexer.number * (S('msdhsfFlL') + 'ms') ^ -1))
