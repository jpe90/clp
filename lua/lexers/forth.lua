...
lex:add_rule('keyword', token(lexer.KEYWORD, word_match({
    ...
    'chars', 'compile,', 'constant,', 'count', 'cr', 'create', 'decimal',
    'defer', 'defer!', 'defer@', 'depth', 'do', 'does>', 'drop', 'dup', 'else',
    'emit', 'endcase', 'endof', 'environment?', 'erase', 'evaluate', 'execute',
    'exit', 'false', 'fill', 'find', 'fm/mod', 'here', 'hex', 'hold', 'holds',
    'i', 'if', 'immediate', 'invert', 'is', 'j', 'key', 'leave', 'literal',
    'loop', 'lshift', 'm*', 'marker', 'max', 'min', 'mod', 'move', 'negate',
    'nip', 'of', 'or', 'over', 'pad', 'parse', 'parse-name', 'pick', 'postpone',
    'quit', 'r>', 'r@', 'recurse', 'refill', 'restore-input', 'roll', 'rot',
    'rshift', 's>d', 'save-input', 'sign', 'sm/rem', 'source', 'source-id',
    'space', 'spaces', 'state', 'swap', 'to', 'then', 'true', 'tuck', 'type',
    'u.', 'u.r', 'u>', 'u<', 'um*', 'um/mod', 'unloop', 'until', 'unused',
    'value', 'variable', 'while', 'within', 'word', 'xor', "[']", '[char]',
    '[compile]'
}, true)))

-- Identifiers.
lex:add_rule('identifier',
             token(lexer.IDENTIFIER, (lexer.alnum + S('+-*=<>.?/\'%,_$#')) ^ 1))
